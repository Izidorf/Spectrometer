...
class LMSClassificator():
	...
	def plotComparison2(self):
		plt.plot(self.SpecterY, 'b-',label='Original data')
		plt.plot(self.SpecterX, 'r-', label='Target data')
		plt.plot(self.SpecterX*self.bestA+self.bestB, 'g-', label='Fitted line')
		plt.legend()
		plt.show()
